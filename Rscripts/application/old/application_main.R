...
CSES.R1
(CSES.R1.metric =  detect_Rieger(CSES.varnames, CSES.data, detection.type = "metric"))

CSES.R2
(CSES.R2.metric =  detect_Rieger_step(CSES.varnames, CSES.data, detection.type = "metric"))

CSES.BV
(CSES.BV.metric =  detect_ByrneVandeVijer(CSES.varnames, CSES.data, group.constraints = "loadings"))

CSES.CR
(CSES.CR.metric = detect_CheungRensvold(CSES.varnames, CSES.data, group.constraints = "loadings"))

CSES.MInd
(CSES.MInd.metric = detect_MInd(CSES.varnames, CSES.data, group.constraints = "loadings"))
...
CSES.out[rownames(CSES.out) %in% CSES.MInd.metric$noninvariant,  6] = "X"
CSES.out[rownames(CSES.out) %in% CSES.CR.metric$noninvariant,  7] = "X"
CSES.out[rownames(CSES.out) %in% CSES.BV.metric$noninvariant,  8] = "X"
CSES.out
...
(Castanho.BV.metric = detectMulti_ByrneVandeVijer(Castanho.varnames, Castanho.model, Castanho.data, group.constraints = "loadings"))
(Castanho.CR.metric = detectMulti_CheungRensvold(Castanho.varnames, Castanho.model, Castanho.data, group.constraints = "loadings"))
(Castanho.MInd.metric = detectMulti_MInd(Castanho.varnames, Castanho.model, Castanho.data, group.constraints = "loadings"))
...
Castanho.out[rownames(Castanho.out) %in% Castanho.MInd.metric$noninvariant,6] = "X"
Castanho.out[rownames(Castanho.out) %in% Castanho.CR.metric$noninvariant,  7] = "X"
Castanho.out[rownames(Castanho.out) %in% Castanho.BV.metric$noninvariant,  8] = "X"
Castanho.out
